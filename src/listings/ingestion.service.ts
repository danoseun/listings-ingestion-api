...
//                 const logCount = sourceName === 'source2' ? recordCount.toLocaleString() : this.formatInThousands(recordCount);
//                 this.logger.log(`Processed ${logCount} records for ${sourceName}`);
//               }
